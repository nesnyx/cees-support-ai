...
class OrderCancelInput(BaseModel):
    ...
    reason: Optional[str] = Field(description="Alasan pembatalan (opsional)", default="")
...
class OrderUpdateInput(BaseModel):
    ...
    customer_name: Optional[str] = Field(description="Nama pelanggan baru (opsional)", default=None)
    product_name: Optional[str] = Field(description="Nama produk baru (opsional)", default=None)
    quantity: Optional[int] = Field(description="Jumlah produk baru (opsional)", default=None)
    level_ice: Optional[str] = Field(description="Level ice baru (opsional)", default=None)
    level_sugar: Optional[str] = Field(description="Level sugar baru (opsional)", default=None)
    temperature: Optional[str] = Field(description="Temperatur baru (opsional)", default=None)